...
<section class="centered-min-section">
        <h2>
  <Fluent.ListItem selected="true" onclick="window.location.href='https://errortek.vercel.app/windowdecorations';">WindowDecorations - Hide the title bar in UWP AppWindow</Fluent.ListItem>
